...
const ButtonSwap = _a => {
  var { as: Button$1 = Button, onClick, swap, children } = _a,
...
const ActionButton = styled(ButtonSwap).withConfig({
  ...
  [
    'padding:4px;background:transparent;font-size:12px;text-transform:uppercase;transition:color 0.3s;&,& a{color:',
    ';}&:hover,& a:hover{color:',
    ';}'
  ],
  p => rgba(textColor(p), 0.4),
  p => rgba(textColor(p), 0.7)
);
...
const Actions = styled.div.withConfig({
  ...
  ['display:flex;justify-content:flex-end;padding:0 5px;background:', ';'],
  getActionsBg
);
const actionStyle = css(
  ['padding:3px 10px;border-left:1px solid ', ';'],
  borderColor
);
...
const getLineBackground = p =>
  mode(p) === 'light'
    ? darken(0.05, borderColor$1(p))
    : lighten(0.06, borderColor$1(p));

const line = position => p =>
  css(
    [
      "content:'';position:absolute;display:block;top:",
      ';left:',
      ';width:',
      ';height:',
      ';background:',
    ...
    p.horizontal ? '50%' : position,
    p.horizontal ? position : '50%',
    p.horizontal ? '2px' : '25px',
    p.horizontal ? '25px' : '2px',
    getLineBackground
  );

const whenHorizontal = (on, off) => p => (p.horizontal ? on : off);

const handleHeight = p =>
...
const Handle = styled.div.withConfig({
  ...
  p => (p.full ? (p.horizontal ? 9999 : 9998) : 9),
  whenHorizontal(HANDLE_SIZE, 'calc(100% + 3px)'),
  handleHeight,
  p => lighten(0.03, borderColor$1(p)),
  whenHorizontal('0 4px 4px 0', '0 0 4px 4px'),
  p => darken(0.01, preBg(p)),
  whenHorizontal(
    `
      top: 0;
      right: 0;
...
const Wrapper$1 = styled.div.withConfig({
  ...
  ['margin:30px 0;position:relative;width:100%;border:1px solid ', ';'],
  get('colors.border')
);
...
const Overlay = styled.div.withConfig({
  ...
  whenFullscreen(9999, 0),
  whenFullscreen('fixed', 'relative'),
  whenFullscreen('100vw', 'auto'),
  whenFullscreen('100vh', 'auto'),
  whenFullscreen('60px 20px 20px', '0px'),
  whenFullscreen('0px', '0 0 30px'),
  whenFullscreen('rgba(0,0,0,0.5)', 'transparent')
);
...
const Wrapper$2 = styled.div.withConfig({
  ...
  whenFullscreen(minusHandleSize, '100%'),
  minusHandleSize,
  borderColor$2
);
...
const PreviewWrapper = styled.div.withConfig({
  ...
  [
    'position:relative;flex:1;border-bottom:1px solid ',
    ';background:',
    ';min-height:',
    ';'
  ],
...
const StyledError = styled(LiveError).withConfig({
  ...
  [
    'position:absolute;top:0;left:0;width:calc(100% - 40px);height:calc(100% - 40px);padding:20px;margin:0;background:',
...
const Playground = ({
  ...
  return createElement(
    ...
    createElement(
      ...
      fullscreen
        ? createElement(ResizeBar, {
            onChangeSize: handleSetSize
          })
        : null,
      createElement(
        Resizable,
        Object.assign({}, resizableProps),
        createElement(
          Wrapper$2,
          {
            full: fullscreen
...
const Blockquote = styled.blockquote.withConfig({
  ...
  get('colors.blockquoteBg'),
  get('colors.blockquoteBorder'),
  get('colors.blockquoteColor'),
...
const Icon = styled(Hash).withConfig({
  ...
  [
    'position:absolute;display:inline-block;top:11px;left:-28px;opacity:0;transition:opacity 0.2s;color:',
    ';'
  ],
  get('colors.primary')
);
const Heading = styled.h2.withConfig({
  ...
  ['position:relative;&:hover .heading--Icon{opacity:1;}', ';'],
  get('styles.h2')
);
const H2 = _a => {
  var { children } = _a,
...
const Hr = styled.hr.withConfig({
  ...
  ['border:none;border-top:1px dashed ', ';margin:40px 0;', ';'],
  get('colors.border'),
  get('styles.hr')
);
...
const Loading = () =>
  createElement(Wrapper$3, null, createElement(Spinner, null));
...
const Link$1 = styled.a.withConfig({
  ...
  [
    '&:hover .octo-arm{animation:',
    ' 560ms ease-in-out;}& .octo-arm{transform-origin:130px 106px;}@media screen and (max-width:500px){&:hover .octo-arm{animation:none;}& .octo-arm{animation:',
    ' 560ms ease-in-out;}}'
  ],
  octocatWave,
  octocatWave
...
const Svg = styled.svg.withConfig({
  ...
  ['z-index:99;fill:', ';color:', ';position:absolute;top:0;border:0;right:0;'],
  get('colors.primary'),
  get('colors.background')
);
...
const Wrapper$4 = styled.div.withConfig({
  ...
  [
    "position:relative;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;padding:24px;a,a:hover,a:visited{text-decoration:none;}&:before{position:absolute;content:'';top:0;left:0;width:100%;height:3px;background:",
    ';}@media screen and (max-width:',
    'px){&:before{height:',
    ';}}',
    ';'
  ],
  p => sidebarPrimary(p) || primaryColor(p),
  breakpoints.desktop,
  p => (p.showBg ? '3px' : 0),
  get('styles.logo')
);
...
const LogoText = styled('h1').withConfig({
  ...
  [
    'margin:5px 0;font-size:24px;font-weight:600;letter-spacing:-0.015em;color:',
    ';'
  ],
  get('colors.sidebarText')
);
const Logo = ({ showBg }) => {
  const {
    base,
...
const Wrapper$5 = styled.div.withConfig({
  ...
  [
    'display:flex;align-items:center;padding:5px 24px;margin-bottom:20px;border-top:1px dotted ',
...
const Input = styled.input.withConfig({
  ...
  [
    'outline:none;width:100%;padding:10px;background:transparent;border:none;font-size:16px;color:',
    ';'
  ],
  sidebarText
);
...
const Link$2 = styled.a.withConfig({
  ...
  [
    ...
    ";}&.active{opacity:1;}&:before{z-index:1;position:absolute;display:block;content:'';top:1px;left:0;width:0;height:20px;background:",
    ';transition:width 0.2s;}&.active:before{width:2px;}'
  ],
  get('colors.sidebarText'),
  p => sidebarPrimary$1(p) || primaryColor$1(p)
);
const SmallLink = _a => {
  var { as: Component, slug, location } = _a,
...
const MenuHeadings = ({ route, onClick }) => {
  ...
  return headings && headings.length > 0
    ? createElement(Location, null, ({ location }) =>
        createElement(
          Submenu,
          null,
...
const Wrapper$6 = styled.div.withConfig({
  ...
  [
    "position:relative;transition:padding 0.2s;&:after{position:absolute;display:block;content:'';top:30px;left:24px;width:0;height:calc(100% - 36px);border-left:1px dashed ",
    ';transition:width 0.2s;}',
    ';'
  ],
  get('colors.sidebarBorder'),
...
const createLink = Link =>
  styled(Link).withConfig({
    ...
    [
      'position:relative;display:block;padding:4px 24px;font-weight:600;font-size:18px;letter-spacing:-0.02em;color:',
    ...
    get('colors.sidebarText'),
    get('colors.sidebarText'),
    p => get('colors.sidebarPrimary')(p) || get('colors.primary')(p)
  );
const LinkAnchor = createLink(
  styled.a.withConfig({
...
const List = styled.dl.withConfig({
  ...
  ['flex:1;overflow-y:auto;visibility:', ';max-height:', ';'],
  p => (p.opened ? 'visible' : 'hidden'),
  p => (p.opened ? 'auto' : '0px')
);
...
const Icon$2 = styled.div.withConfig({
  ...
  [
    'position:absolute;top:50%;right:20px;transform:translateY(-50%) rotate(',
...
const Docz = ({ width = 100, className }) =>
  createElement(
    'svg',
    {
      width: width,
...
const Icon$3 = styled.div.withConfig({
  ...
  [
    'position:relative;width:23px;height:32px;transform:translateX(',
    ') translateY(',
    ') scale(',
    ');'
  ],
...
const IconLine = styled.span.withConfig({
  ...
  [
    ...
    ';transition:transform 0.3s,opacity 0.3s;&:nth-of-type(1){top:-2px;transform:translateY(',
    ') rotate(',
    ');}&:nth-of-type(2){top:6px;opacity:',
    ';}&:nth-of-type(3){top:14px;transform:translateY(',
    ') rotate(-',
    ');}'
  ],
  p => (p.opened ? sidebarText$1(p) : textColor$1(p)),
  IconFirst,
  IconRotate,
  IconMiddle,
  IconLast,
...
const ToggleButton = styled.button.withConfig({
  ...
  [
    'cursor:pointer;z-index:99;position:absolute;display:flex;align-items:center;justify-content:center;padding:5px 6px;width:33px;height:30px;top:',
    ';right:',
    ';transform:translateX(',
    ') translateY(',
    ');transition:transform 0.3s;outline:none;border:none;background:',
    ';border-radius:',
    ";&:before{position:absolute;content:'';top:-3px;left:0;width:calc(100% + 1px);height:",
    ';background:',
    ';}',
    ';'
  ],
  p => (p.opened ? '3px' : '2px'),
  p => (p.opened ? '-39px' : '-27px'),
  translateX,
  translateY,
  p => (p.opened ? sidebarBg(p) : backgroundColor$1(p)),
  p => (p.opened ? `0 0 ${radii(p)} 0` : `${radii(p)}`),
  p => (p.opened ? '3px' : 0),
  p => sidebarPrimary$2(p) || primaryColor$2(p),
  mq({
    display: ['block', 'block', 'block', 'none']
  })
);
const Hamburger = ({ opened, onClick }) =>
  createElement(
    ToggleButton,
    {
      opened: opened,
...
const Wrapper$8 = styled.div.withConfig({
  ...
  [
    'position:relative;width:280px;min-width:280px;min-height:100vh;background:',
    ';transition:transform 0.2s,background 0.3s;z-index:1000;',
    ';dl{padding:0;margin:0 16px;}dl a{font-weight:400;}@media screen and (max-width:',
    ...
    createElement(
      ...
      createElement(
        ...
        menus && menus.length === 0
          ? createElement(Empty, null, 'No documents found.')
          : createElement(
              Menus,
              null,
              menus &&
...
const Wrapper$9 = styled.div.withConfig({
  ...
  [
    'display:flex;align-items:center;justify-content:center;flex-direction:column;width:100%;height:100vh;color:',
    ';background:',
    ';'
  ],
  get('colors.text'),
...
const OrderedList = styled.ol.withConfig({
  ...
  [
    "list-style:none;counter-reset:my-awesome-counter;& li{counter-increment:my-awesome-counter;}& li::before{content:counter(my-awesome-counter) '. ';color:",
    ";font-weight:bold;font-family:'Playfair Display',serif;margin-right:5px;}",
    ';'
  ],
  get('colors.border'),
  get('styles.ol')
...
const Wrapper$a = styled.div.withConfig({
  ...
  ['flex:1;color:', ';background:', ';min-width:0;position:relative;'],
  get('colors.text'),
  get('colors.background')
);
...
const EditPage = styled(ButtonLink.withComponent('a')).withConfig({
  ...
  [
    'display:flex;align-items:center;justify-content:center;position:absolute;padding:2px 8px;margin:8px;border-radius:',
    ';border:1px solid ',
    ';opacity:0.7;transition:opacity 0.4s;font-size:14px;color:',
    ';text-decoration:none;text-transform:uppercase;&:hover{opacity:1;background:',
    ';}',
    ';'
  ],
  get('radii'),
...
const Page = ({
  ...
  return createElement(
    ...
    createElement(
      Wrapper$a,
      null,
      fullpage ? content : createElement(Container, null, content)
    )
  );
};
...
const PropName = styled.span.withConfig({
  ...
  [
    'background:',
    ';color:',
    ';padding:5px 10px;border-radius:4px 4px 0 0;font-size:16px;font-weight:500;& ~ &{margin-left:5px;}'
  ],
  get('colors.propsBg'),
  get('colors.primary')
);
const PropType = styled(PropName).withConfig({
  ...
  ['color:', ';background:', ';font-weight:400;'],
  get('colors.propsText'),
  get('colors.propsBg')
);
...
const PropsRaw = ({ props, getPropType }) => {
  const entries = Object.entries(props);
  const components = useComponents();
  const Paragraph = useMemo(
    () =>
      styled(components.P || 'p').withConfig({
          ...
          prop.defaultValue &&
            createElement(
              ...
              prop.defaultValue.value === "''"
                ? createElement('em', null, '= [Empty String]')
                : createElement(
                    'em',
                    null,
                    '= ',
...
const Line = styled.div.withConfig({
  ...
  [
    'padding:8px 0;@media (min-width:',
    '){padding:O;}& + &{border-top:1px solid ',
    ';}'
  ],
  breakpoint,
  get('colors.border')
...
const Column = styled.div.withConfig({
  ...
  [
    'min-width:0;padding:2px 15px;word-wrap:break-word;@media (min-width:',
    '){padding:8px 15px;}'
  ],
  breakpoint
);
...
const PropsTable = ({ props, getPropType }) => {
  const entries = Object.entries(props);
  const components = useComponents();
  const Paragraph = useMemo(
    () =>
      styled(components.P || 'p').withConfig({
        ...
        ['margin:0;font-size:16px;color:', ';padding:0 15px 8px 15px;'],
        get('colors.blockquoteColor')
      ),
    []
  );
    ...
    entries.map(([key, prop]) => {
      ...
      return createElement(
        ...
        createElement(
          Content$1,
          null,
          createElement(ColumnName, null, createElement(PropName$1, null, key)),
          createElement(
            ColumnType,
            null,
            createElement(PropType$1, null, getPropType(prop))
          ),
          createElement(
            ColumnValue,
            null,
            ...
            prop.required &&
              createElement(
                PropRequired$1,
                null,
                createElement('strong', null, 'required')
              )
          )
        ),
        prop.description && createElement(Paragraph, null, prop.description)
...
const Props = _a => {
  ...
  const Title = useMemo(
    () =>
      styled(components.H3 || 'h3').withConfig({
  ...
  return createElement(
    ...
    isOpen &&
      createElement(
        ...
        null,
        isRaw
          ? createElement(PropsRaw, Object.assign({}, props))
          : createElement(PropsTable, Object.assign({}, props))
      )
  );
};
...
const Wrapper$c = styled.div.withConfig({
  ...
  ['overflow-x:auto;padding:2px;margin-bottom:30px;', ';'],
  mq({
    marginBottom: [20, 40],
...
const TableStyled = styled.table.withConfig({
  ...
  [
    'padding:0;table-layout:auto;box-shadow:0 0 0 1px ',
    ';background-color:transparent;border-spacing:0;border-collapse:collapse;border-style:hidden;border-radius:',
    ';font-size:14px;color:',
    ';',
    ' & thead{color:',
    ';background:',
    ';}& thead th{font-weight:400;padding:20px 20px;&:nth-of-type(1){',
    ';}&:nth-of-type(2){',
    ';}&:nth-of-type(3){',
    ';}&:nth-of-type(4){',
    ';}&:nth-of-type(5){',
...
const UnorderedList = styled.ul.withConfig({
  ...
  [
    "list-style:none;& li::before{content:'\u25CF ';color:",
    ';font-weight:bold;font-size:0.5em;margin-right:5px;}',
...
const styles = {
  body: css(
    ['font-family:', ';font-size:16px;line-height:1.6;'],
    get('fonts.ui')
  ),
  h1: css(
    [
      'margin:40px 0 20px;font-family:',
  ...
  h2: css(
    [
      'margin:30px 0 15px;line-height:1.4em;font-family:',
  ...
  h6: css([
    'margin:20px 0 10px;font-size:16px;font-weight:400;text-transform:uppercase;'
  ]),
  ...
  code: css(
    [
      'margin:0 3px;border-radius:3px;font-family:',
      ";padding:2px 5px;font-size:0.8em;border:'1px solid rgba(0, 0, 0, 0.02)';"
    ],
    get('fonts.mono')
  ),
  pre: css(
    ['font-family:', ';font-size:1em;line-height:1.8;'],
    get('fonts.mono')
  ),
  paragraph: css(['margin:10px 0 20px 0;']),
  table: css(
    [
      'overflow-y:hidden;width:100%;font-family:',
      ';font-size:16px;overflow-x:initial;display:block;'
    ],
    get('fonts.mono')
  ),
  blockquote: css([
    'margin:25px 0;padding:20px;font-style:italic;font-size:16px;'
  ])
};
